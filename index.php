...
<section class="my-5">
  <div class="py-5">
    <h2 class="text-center" id="aboutus">About Us <hr class="width:60% margin-left:auto margin-right:auto" /></h2>
...
<section class="my-5">
  <div class="py-5">
    <div class="pt-5">
    <h2 class="text-center pt-5" id="ourservice">Our services</h2><hr></div>
</div>
<div class="container-fluid">
  <div class="row">
...
<section class="my-5">
  <div class="py-5">
    <h2 class="text-center" id="gallary">Gallary <hr></h2>
</div>
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
...
<script type="text/javascript">
  function sendEmail(){
$.ajax({url:'userinfo.php}',method: 'POST',dataType:'json',
